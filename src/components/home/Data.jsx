...
const Data = () => {
    return(
        <div className="home__data">
            <h1 className="home__title">Younes Lahrichi
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <p className="home__description"> Creative and passionate software engineer with an insatiable appetite for learning, dedicated to making a meaningful difference in the world.  </p>
